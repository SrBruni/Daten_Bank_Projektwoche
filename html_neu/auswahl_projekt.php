...
<body>
    <form method="post" action="">
	 <h1>Teilnahme an einem Projekt</h1>
        <h2> Wähle eine(n) Schüler(in) und ein Projekt aus: </h2>
        <table>
            <tr>
                <td>
        ...
        try {
            ...
            if ($row_projekt) {
                ...
                if ($count == 0) {
                    ...
                    $stmt_max_teilnehmer = $con->prepare("SELECT pMaxPers FROM projekt WHERE pnummer = :pnummer");
